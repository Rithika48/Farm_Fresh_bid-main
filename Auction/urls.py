...
from bid_app.views import signup_view  # Ensure this is present
from bid_app.views import logout_user  # Ensure this is present
from bid_app.views import add_product  # Ensure this is present
from bid_app.views import edit_profile  # Ensure this is present
...
urlpatterns = [
    ...
    path('logout/', logout_user, name='logout'),  # Ensure this line is correct
    path('add_product/', add_product, name="add_product"),  # Ensure this line is correct
    ...
    path('edit_profile/', edit_profile, name="edit_profile"),  # Ensure this line is correct

    path('load-courses/', load_courses, name='ajax_load_courses'),  # Ensure this line is correct
    ...
    path('add_categary', add_category, name="add_categary"),
    path('view_categary', view_category, name="view_categary"),
    # Removed all references to sub_category
